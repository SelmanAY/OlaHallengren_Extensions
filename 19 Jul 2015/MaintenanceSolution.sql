...
@PartitionNumber int = NULL,
@ExtendedInfo xml = NULL,
@ExecutionKey nvarchar(4000) = NULL,
...
BEGIN
  ...
  IF @LogToTable = 'Y'
  BEGIN
    INSERT INTO dbo.CommandLog (DatabaseName, SchemaName, ObjectName, ObjectType, IndexName, IndexType, StatisticsName, PartitionNumber, ExtendedInfo, CommandType, Command, StartTime, ExecutionKey)
    VALUES (@DatabaseName, @SchemaName, @ObjectName, @ObjectType, @IndexName, @IndexType, @StatisticsName, @PartitionNumber, @ExtendedInfo, @CommandType, @Command, @StartTime, @ExecutionKey)
  END
  ...
  BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        EXECUTE @CurrentCommandOutput01 = [dbo].[CommandExecute] @Command = @CurrentCommand01, @CommandType = @CurrentCommandType01, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @ExecutionKey = @ExecutionKey, @LogToTable = @LogToTable, @Execute = @Execute
        SET @Error = @@ERROR
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput02 = [dbo].[CommandExecute] @Command = @CurrentCommand02, @CommandType = @CurrentCommandType02, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @ExecutionKey = @ExecutionKey, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
      ...
      BEGIN
        ...
        BEGIN
          ...
          EXECUTE @CurrentCommandOutput05 = [dbo].[CommandExecute] @Command = @CurrentCommand05, @CommandType = @CurrentCommandType05, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @ExecutionKey = @ExecutionKey, @LogToTable = @LogToTable, @Execute = @Execute
          SET @Error = @@ERROR
  ...
  BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        BEGIN
          ...
          BEGIN
            ...
            EXECUTE @CurrentCommandOutput08 = [dbo].[CommandExecute] @Command = @CurrentCommand08, @CommandType = @CurrentCommandType08, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @SchemaName = @CurrentSchemaName, @ObjectName = @CurrentObjectName, @ObjectType = @CurrentObjectType, @ExecutionKey = @ExecutionKey, @LogToTable = @LogToTable, @Execute = @Execute
            SET @Error = @@ERROR
      ...
      BEGIN
        ...
        EXECUTE @CurrentCommandOutput09 = [dbo].[CommandExecute] @Command = @CurrentCommand09, @CommandType = @CurrentCommandType09, @Mode = 1, @DatabaseName = @CurrentDatabaseName, @ExecutionKey = @ExecutionKey, @LogToTable = @LogToTable, @Execute = @Execute
        SET @Error = @@ERROR
